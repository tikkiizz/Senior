...
class PromotionTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        for object in promotionObj!{
            ...
            let promotion = Promotion()
            promotions.append(promotion)
            promotions[j].setPromoName((object.valueForKey("promotionName") as! String))
            promotions[j].setPromoDetail((object.valueForKey("promotionDetail") as! String))
            //promotions.append(promotion)
            //print(promotionID[i])
            ...
            do {
                ...
                if let imageData = imgData {
                    ...
                    promotions[j].setPromoPic(image!)
